...
best_model.compile(loss="mse", optimizer=Adam(learning_rate = 0.0001))##模型训练参数
history = best_model.fit([x_train_dynamic], y_train, epochs= 100, batch_size= 256, validation_data=([x_test_dynamic], y_test))
